        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Update Course</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                action="{{ route('admin.courses.update', $course) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 mt-4 row">
                                                ...
                                                <div class="col-lg-8 form-material">
                                                        <input  value="{{ $course->start }}" type="date" name="start" class="form-control  @error('start') is-danger @enderror"  id="validationStartCourse" placeholder="Enter the course start date">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="mb-3 mt-4 row">
                                                ...
                                                <div class="col-lg-8 form-material">
                                                        <input value="{{ $course->end }}" type="date" name="end" class="form-control  @error('end') is-danger @enderror"  id="validationEndCourse" placeholder="Enter the course End date">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="mb-3 mt-5 row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea name="description" class="form-control3" rows="33">{{ $course->description }} </textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="category_id" class="form-select form-select-lg mb-3"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id == $category->id ? $category->id : '' }}"
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="subcategory_id" class="form-select form-select-lg mb-3"
                                                        ...
                                                        @foreach ($subcategories as $subcategory)
                                                            <option value="{{ $subcategory->id == $subcategory->id ? $subcategory->id : '' }}"
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="teacher_id" class="form-select form-select-lg mb-3"
                                                        ...
                                                        @foreach ($teachers as $teacher)
                                                            <option value="{{ $teacher->id == $teacher->id ? $teacher->id : '' }}"
