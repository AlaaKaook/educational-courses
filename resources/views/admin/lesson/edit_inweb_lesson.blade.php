        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Update Lesson</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                ...
                                action="{{ route('admin.update_inweb', $lesson) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="mb-3 mt-5 row">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea name="description" class="form-control3" rows="33" cols="125">{{ $lesson->description }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <select name="course_id" class="form-select form-select-lg mb-3"
                                                        ...
                                                        @foreach ($courses as $course)
                                                            <option value="{{ $course->id == $course->id ? $course->id : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="input-group mb-3 mt-4">
                                                <label class="col-lg-2 col-form-label" for="validationdescription">Content Lesson
                                                    <span class="text-danger">*</span>
                                                </label>
