...
@section('title', 'Sub Category Informations')
                    ...
                    <div class="card overflow-hidden">
                        <div class="text-center p-3 overlay-box " style="background-image: url({{ asset('assets/dashboard/images/big/img1.jpg') }});">
                            <div class="profile-photo">
                                <img src="{{ asset('assets/upload/images/subcategory_img/' . $subcategory->image) }}" width="100" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li><span class="mb-0 mx-5 mt-2"><h4 class="center-position">Sub Category Description</h4>
                        ...
                        <div class="card-footer border-0 mt-0">
                            <button class="btn btn-primary btn-lg btn-block">
                                <i class="fa fa-bell-o"></i> BACK TO ALL SUB CATEGORY
                            </button>
                        </div>
                    </form>
                    </div>
